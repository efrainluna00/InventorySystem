 ...
 */
public class RepExistenciasAction extends DispatchAction {
	...
	public ActionForward inicio(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response){
		RepExistenciasForm repExistenciasform = (RepExistenciasForm)form;
		repExistenciasform.setBodega("%");
		repExistenciasform.setBodegaDesc("Todas las Bodegas");
		try {		 
	...
	public ActionForward rptMovRecurso(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws JRException, IOException, SQLException{
		...
		String formato = repExistenciasform.getFormato();
		...
		String ruta;
		ruta=this.getServlet().getServletContext().getRealPath("reportesJasper/existencias_recursos.jasper");
		HashMap<String, String> parameters = new HashMap<String, String>();
		//parameters.put("pQuery",queryString);
		//parameters.put("pUsuario",usuario);
        if (repExistenciasform.getBodega() != null && !repExistenciasform.getBodega().trim().equals("")&& !repExistenciasform.getBodega().equals("%")){
         
        	parameters.put("p_bodega",repExistenciasform.getBodega());
        }
        
        parameters.put("p_cero",repExistenciasform.getCero());
