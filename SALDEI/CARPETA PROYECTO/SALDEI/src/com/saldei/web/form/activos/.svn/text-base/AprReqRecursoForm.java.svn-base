 ...
 * 
 * XDoclet definition:
 * @struts.form name="aprRecRecursoForm"
 */
public class AprReqRecursoForm extends ActionForm {
...
/**
	...
	public String getDetRequisicionLink() {
		...
		//(accion, manualCode,codBodega,bodDes,tipoSol,solicitante,motivoRechazo,comentario
