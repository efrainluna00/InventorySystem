 ...
 * 
 * XDoclet definition:
 * @struts.form name="detAprSolSuministroForm"
 */
public class DetAprSolSuministroForm extends ActionForm {
	/*
	 * Generated Methods
	 */
	...
	public String getComentario() {
		return actDetSolicitud.getId().getActSolicitud().getMotivoRechazo();
	}
	...
	public void setComentario(String comentario) {
		actDetSolicitud.getId().getActSolicitud().setMotivoRechazo(comentario);
	}
