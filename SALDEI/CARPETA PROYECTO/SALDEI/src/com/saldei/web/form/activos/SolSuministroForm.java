 ...
 */
public class SolSuministroForm extends ActionForm {
	...
	/**
	 * @return the unidadSol
	 */
	public String getUnidadSol() {
		return unidadSol;
	}

	/**
	 * @param unidadSol the unidadSol to set
	 */
	public void setUnidadSol(String unidadSol) {
		this.unidadSol = unidadSol;
	}
...
/**
	...
	public String getDetRequisicionLink() {
		...
		String link = " <a  href='#' onclick=\"javascript:mostrarDetRequisicion('Find','"
			+ this.getId().getCodSolicitud()+ "','"+ this.getCodBodega()+"','"+this.getBodegaDes()+"','"+this.getUnidadDes()+"','"+this.getId().getTipoSolicitud()+"');return false;\" >";
	   link += " Detalle</a>";	
...
return link;
	...
	public String getBodegaEditable() {
