 ...
 * 
 * XDoclet definition:
 * @struts.form name="aprSolSuministroForm"
 */
public class AprSolSuministroForm extends ActionForm {
...
/**
	 ...
	 */
	public String getSuministroLink() {
		//return actSolicitud.getDetRequisicionLink();
		//accion, manualCode,codBodega,bodDes,tipoSol,solicitante,comentario
		String link = " <a  href='#' onclick=\"javascript:mostrarDetSolSum('Find','"
