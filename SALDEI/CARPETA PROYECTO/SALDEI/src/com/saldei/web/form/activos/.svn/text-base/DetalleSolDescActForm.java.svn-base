 ...
 */
public class DetalleSolDescActForm extends ActionForm {
	/*
	 * Generated Methods
	 */
	...
	public void validate(ActionMapping mapping,
		...
		if(!accion.equals(mensajes.getString("opc.cancel")) && !accion.equals(mensajes.getString("opc.find"))){
			if(this.getCodActivo() == null ||  this.getCodActivo().toString().trim().equals("") ){
				errors.add("detsoldesca.activo.requerido", new ActionError("detsoldesca.activo.requerido"));
			}
