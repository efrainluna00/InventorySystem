 ...
 */
public class ReqRecursoForm extends ActionForm {
	...
	public void validate(ActionMapping mapping,
		...
		if(!accion.equals(mensajes.getString("opc.cancel")) && !accion.equals(mensajes.getString("opc.find"))){
			if(this.actSolicitud.getCodBodega() == null || this.actSolicitud.getCodBodega().equals("")){
				errors.add("requisicion.bodega.requerido", new ActionError("requisicion.bodega.requerido"));
			}
			if(this.actSolicitud.getActUnidad().getCodUnidad() == null || this.actSolicitud.getActUnidad().getCodUnidad().equals("")){
				errors.add("requisicion.unidad.requerido", new ActionError("requisicion.unidad.requerido"));
			}
...
return link;
	...
	public void setBodegaEditable(String bodegaEditable) {
		this.bodegaEditable = bodegaEditable;
	}
