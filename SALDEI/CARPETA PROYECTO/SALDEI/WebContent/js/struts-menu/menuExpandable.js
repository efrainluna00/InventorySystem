...
function initializeMenu(menuId, actuatorId) {
    ...
    actuator.parentNode.style.backgroundImage = "url(images/struts-menu/plus.gif)";
    actuator.onclick = function() {
        var display = menu.style.display;
        this.parentNode.style.backgroundImage =
            (display == "block") ? "url(images/struts-menu/plus.gif)" : "url(images/struts-menu/minus.gif)";
...
function openMenu(menuId) {
    ...
    if (menu != null) {
        var display = menu.style.display;
        menu.parentNode.style.backgroundImage = "url(images/struts-menu/minus.gif)";
        menu.style.display = (display == "block") ? "none" : "block";
    }
}
