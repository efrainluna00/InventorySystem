...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="scripts" type="String">
        ...
        function enviar(accion){
			...
			function tableClick(codBaja,descripcion){
			  	$(".error").hide();	
			  	document.getElementById('codBaja').value = codBaja;	
	...
	<tiles:put name="title" type="String">
		<bean:message key="moba.titulo" />
	</tiles:put>

	<tiles:put name="encabezado" type="String">
		<bean:message key="moba.encabezado" />
	</tiles:put>

	<tiles:put name="contenido" type="String">
		<html:form action="/motivoBajaAction.do" styleId="formulario">
			<center>

				<table class="tableDefault">
					<tr>
						<th>
							<bean:message key="moba.descripcion" />
						</th>
						<td>
							<html:hidden property="codBaja" styleId="codBaja"></html:hidden>
							...
							<html:messages id="message" footer="errores.pie"
								header="errores.cabecera" property="moba.descripcion.requerido">
								<br>
				...
				<html:messages id="message" footer="errores.pie"
					header="errores.cabecera" property="moba.mensaje.exito">
					<div id="mensaje">
				...
				<html:messages id="message" footer="errores.pie"
					header="errores.cabecera" property="moba.mensajeError.error">
					<div id="mensajeError">
						<bean:write name="message" filter="false" />
					</div>
					<script type="text/javascript" language="javascript">
		...
		<ec:table items="listaMotivoBaja" var="mapf"
			action="${pageContext.request.contextPath}/motivoBajaAction.do?accion=Find"
			imagePath="${pageContext.request.contextPath}/images/table/compact/*.gif"
			title='Motivo de Baja' view="compact" width="50%"
			tableId="motivoBaja" autoIncludeParameters="yes" scope="request">
			<ec:row highlightRow="true"
				onclick="tableClick('${pageScope.mapf.codBaja}','${pageScope.mapf.descripcion}');">
