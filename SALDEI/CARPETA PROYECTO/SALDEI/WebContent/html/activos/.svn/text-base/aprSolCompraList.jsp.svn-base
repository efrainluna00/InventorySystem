...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="contenido" type="String">
		...
		<html:form action="/aprSolCompraAction.do" styleId="formulario">
			...
			<ec:table items="listSolComprasEnviadas" var="mapf"
				action="${pageContext.request.contextPath}/aprSolCompraAction.do?accion=Find"
				imagePath="${pageContext.request.contextPath}/images/table/compact/*.gif"
				title='Solicitudes' view="compact" width="80%" tableId="solCompras"
				autoIncludeParameters="yes" scope="request" form="formulario">
				<ec:row highlightRow="true">
					...
					<ec:column property="linkAprSolicitudCompra" title="Acci&oacute;n"
