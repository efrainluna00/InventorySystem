...
function generarReporte(){
		...
		document.forms[0].cmd.value = 'rptMateria';
...
<body>
<html:form action="/rptMaterias" styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Materias del Departamento</div><br/>
			<table align="center">
				<tr>
					<td align="center">
						<fieldset>
							<table align="center">
								...
								<tr>
									<td colspan="3" align="left">
									    <input type = "radio" name="estado" id="estadoA" value="A" checked="true"/><label for="estadoA">Materias Activas </label><br/>
										<input type = "radio" name="estado" id="estadoI" value="I"/><label for="estadoI">Materias Inactivas </label><br/>
										<input type = "radio" name="estado" id="estadoE" value="est_materia"/><label for="estadoE">Todas </label><br/>
									</td>																	
								</tr>	
								<tr></tr>				
								<tr>					
