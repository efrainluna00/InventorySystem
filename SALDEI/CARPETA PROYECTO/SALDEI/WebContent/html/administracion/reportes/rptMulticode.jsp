...
function generarReporte(){
		...
		document.forms[0].cmd.value = 'rptMulticode';
...
<body>
<html:form action="/rptMulticode"  styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de C&oacute;digos M&uacute;ltiples del Sistema </div><br/>
			<table align="center">
				<tr>
					<td align="center">
						<fieldset>
							...
							<tr>						
								<td colspan="3" align="left">
								    <input type = "radio" name="estado" id="estadoA" value="A" checked="true"/><label for="estadoA">C&oacute;digo M&uacute;ltiples Activas </label><br/>
									<input type = "radio" name="estado" id="estadoI" value="I"/><label for="estadoI">C&oacute;digo M&uacute;ltiples  Inactivas </label><br/>
									<input type = "radio" name="estado" id="estadoE" value="est_multicode"/><label for="estadoE">Todas </label><br/>
								</td>						
