...
function generarReporte(){
		...
		document.forms[0].cmd.value = 'rptTipoMulticode';
...
<body>
<html:form action="/rptTipoMulticode" styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Tipos de C&oacute;digos M&uacute;ltiples del Sistema </div><br/>
			<table align="center">
		<tr>
			<td align="center">
				<fieldset>
					...
					<tr>
						<td colspan="3" align="left">
						    <input type = "radio" name="estado" id="opcion4" value="A" checked="true"/><label for="opcion4">Tipo C&oacute;digo M&uacute;ltiples Activas </label><br/>
							<input type = "radio" name="estado" id="opcion5" value="I"/><label for="opcion5">Tipo C&oacute;digo M&uacute;ltiples Inactivas </label><br/>
							<input type = "radio" name="estado" id="opcion6" value="est_tipoMulticode"/><label for="opcion6">Todas </label><br/>
						</td>								
					</tr>				
					<tr>
