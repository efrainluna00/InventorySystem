...
function generarReporte(){
		document.forms[0].cmd.value = 'rptTipoMedida';
...
<body>
<html:form action="/rptTipoMedida"  styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Tipos de Medida del Sistema </div><br/>
				<table align="center">
					<tr>
						<td align="center">
						<fieldset>
							...
							<tr>			
								<td colspan="3" align="left">
								    <input type = "radio" name="estado" id="opcion4" value="A" checked="true"/><label for="opcion4">Tipo Medida Activas </label><br/>
									<input type = "radio" name="estado" id="opcion5" value="I"/><label for="opcion5">Tipo Medida Inactivas </label><br/>
									<input type = "radio" name="estado" id="opcion6" value="est_tipoMedida"/><label for="opcion6">Todas </label><br/>
								</td>														
							</tr>
							<tr></tr>
							<tr>
