...
<script type="text/javascript">
	...
	function generarReporte(){
			...
			document.forms[0].cmd.value = 'rptLaboratorio';
...
<body>
<html:form action="/rptLaboratorio" styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Laboratorios del Departamento </div><br/>
			<table align="center">
				<tr>
					<td align="center">
					<fieldset> 
						<table align="center">
							...
							<tr>	
								<td colspan="3" align="left">
								    <input type = "radio" name="estado" id="estadoA" value="A" checked="true"/><label for="estadoA">Laboratorios Activos</label><br/>
									<input type = "radio" name="estado" id="estadoI" value="I"/><label for="estadoI">Laboratorios Inactivos</label><br/>
									<input type = "radio" name="estado" id="estadoE" value="est_laboratorio"/><label for="estadoE">Todos</label><br/>
								</td>
							</tr>
							<tr>
