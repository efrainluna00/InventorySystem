...
function generarReporte(){
	if(document.forms[0].ciclo.value=='Seleccione'){			
		...
		document.forms[0].cmd.value = 'rptMateriaCiclo';
...
<body>
<html:form action="/rptMateriaCiclo" styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule">Reporte de Materias por Ciclo</div><br/>
			<table align="center">
				<tr>
					<td align="center">
						<fieldset> 
							<table align="center">
								...
								<tr>	
									...
									<td align="left">
										<html:select styleId="ciclo" property="ciclo" styleClass="width_136">	
