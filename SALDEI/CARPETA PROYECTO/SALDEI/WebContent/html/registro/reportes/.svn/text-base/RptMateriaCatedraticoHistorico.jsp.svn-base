...
<%@ page import="com.saldei.web.services.registro.RptMateriaCatedraticoHistoricoService" %>
<html:html>
<head>
...
function generarReporte(){
	if(document.forms[0].cicloinicio.value=='Seleccione' || document.forms[0].ciclofin.value=='Seleccione'){			
		alert('Debe seleccionar el rango de ciclos');		
	}	
	else{		
		if(document.forms[0].cicloinicio.value.substring(2,6) > document.forms[0].ciclofin.value.substring(2,6))
			alert('Rango de ciclos elegido incorrectamente')
		else if(document.forms[0].cicloinicio.value.substring(0,2) > document.forms[0].ciclofin.value.substring(0,2))
			alert('Rango de ciclos elegido incorrectamente')
			else{
...
<%
	RptMateriaCatedraticoHistoricoService services = new RptMateriaCatedraticoHistoricoService();
	request.setAttribute("cic",services.getCiclo());
	request.setAttribute("cat",services.getCatedraticos());
%>

</head>
<body>
<html:form action="/rptMateriaCatedraticoHistorico" styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte Hist&oacute;rico de Materias por Catedratico </div><br/>
			<table align="center">
				<tr>
					<td align="center">
					<fieldset> 
						...
						<tr>	
							...
							<td align="left">
								<html:select styleId="cicloinicio" property="cicloinicio" styleClass="width_136">
						...
						<tr>	
							...
							<td align="left">
								<html:select styleId="catedratico" property="catedratico" styleClass="width_136">
										<html:option value="Seleccione">Seleccione</html:option>
