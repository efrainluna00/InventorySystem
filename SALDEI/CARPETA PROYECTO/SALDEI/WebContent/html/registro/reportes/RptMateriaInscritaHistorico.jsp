...
function generarReporte(){
	if(document.forms[0].cicloini.value=='Seleccione' || document.forms[0].ciclofin.value=='Seleccione'){			
		...
		if(document.forms[0].cicloini.value.substring(2,6) > document.forms[0].ciclofin.value.substring(2,6))
			...
			alert('Rango de ciclos elegido incorrectamente');			
			else if(document.forms[0].carnet.value=='')
				alert('Debe digitar el carnet del estudiante');
				else{
					document.forms[0].cmd.value = 'rptMateriaInscritaEstudiante';
...
<body>
<html:form action="/rptMateriaInscritaHistorico" styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Materias Inscritas por Estudiante - Hist&oacute;rico </div><br/>
			<table align="center">
				<tr>
					<td align="center">	
					<fieldset> 
						<table align="center">
							...
							<tr>
									...
									<td align="left"><html:text property="carnet" size="15" maxlength="10"/></td>
							</tr>				
							<tr>
