...
<script type="text/javascript">
	function generarReporte(){
		if(document.forms[0].tipousuario.value=='Seleccione'){
				alert('Debe seleccionar el tipo de usuario');
		}
		else{
			document.forms[0].cmd.value = 'rptInformacionPersonal';
...
<body>
<html:form action="/rptInformacionPersonal" styleClass="niceform" >
...
<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Informacion Personal </div><br/>
				<table align="center">
					<tr>
						<td align="center">
							<fieldset> 
