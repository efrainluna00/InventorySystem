...
<script type="text/javascript">
	function generarReporte(){
		if(document.forms[0].perfil.value=='Seleccione'){
			alert('Debe seleccionar el perfil');		
		}
		else{
			document.forms[0].cmd.value = 'rptOpcionesPerfil';
...
<body>
<html:form action="/rptOpcionPerfil" styleClass="niceform" >
...
<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Opciones por Perfil </div><br/>
				<table align="center">
					<tr>
						<td align="center">
							<fieldset> 
								...
								<tr>	
									...
									<td align="left"	>
									<html:select property="perfil"  styleId="perfil"  styleClass="width_136" >
										<html:option value="Seleccione">Seleccione</html:option>
										<html:options collection="perf" labelName="idPerfil" labelProperty="nomPerfil" name="selectPerfil" property="idPerfil"/>
									</html:select>
