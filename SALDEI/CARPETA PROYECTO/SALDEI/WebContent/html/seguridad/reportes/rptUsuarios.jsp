...
<script type="text/javascript">
	...
	function showPopUp(){	
		window.open ("rptGenerico.jsp","Reportes","scrollbars=yes,resizable=yes");
		document.forms[0].submit();	
	} 
...
<body>
<html:form action="/rptUsuarios"  styleClass="niceform">
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Usuarios del Sistema </div><br/>
			<table align="center">
				<tr>
					<td align="center">
					<fieldset>
						<table align="center">
							...
							<tr>	
								...
								<td align="left" colspan="2" ><input type="text" name="fechainicial" id="fechainicial" readonly="readonly" size="10"  /><input type="button" value="....." id="btnFecha1" onmousedown="verCalen1()" class="ButtonText"/></td>
							</tr>	
							<tr>						
								<td align="left"><b>Fecha Final:</b></td>
								<td align="left" colspan="2"><input type="text" name="fechafinal" id="fechafinal" readonly="readonly" size="10"  /><input type="button" value="....." id="btnFecha2" onmousedown="verCalen2()" class="ButtonText"/></td>
							</tr>
							<tr>	
							...
							<tr>	
								...
								<td align="left" colspan="2">
									<html:select styleId="estado" property="estado" styleClass="width_136">					
										<html:option value="A">Usuarios Activos</html:option>
										<html:option value="I">Usuario Inactivos</html:option>
									</html:select>							
								</td>
							</tr>
							<tr>
								<td align="center" colspan="3" style="text-align: center;">
								<input type="button" id="btnRpt"    name="btnRpt"    onclick="generarReporte();"   value= "Generar Reporte"/></td>
							</tr>												
						</table>	
					</fieldset>			
					</td>
