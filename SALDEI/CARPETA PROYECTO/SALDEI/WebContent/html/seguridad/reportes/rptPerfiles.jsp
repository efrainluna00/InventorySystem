...
<script type="text/javascript">
	...
	function generarReporte(){
			...
			document.forms[0].cmd.value = 'rptPerfiles';
...
<body>
<html:form action="/rptPerfil" styleClass="niceform"  >
<html:hidden property="cmd" value=""/>
	<div id="wrapper">
		...
		<div id="container"><br/><br/>
			<div id="titule"> Reporte de Perfiles del Sistema </div><br/>
			<table align="center">
				<tr>
					<td align="center">
					<fieldset> 
						...
						<tr>	
							<td colspan="3" align="left">
							    <input type = "radio" name="estado" id="per1" value="A" checked="true"/><label for="per1">Perfiles Activos</label><br/>
								<input type = "radio" name="estado" id="per2" value="I"/><label for="per2">Perfiles Inactivos</label><br/>
								<input type = "radio" name="estado" id="per3" value="est_perfil"/><label for="per3">Todos</label><br/>
							</td>
						</tr>
						<tr>
