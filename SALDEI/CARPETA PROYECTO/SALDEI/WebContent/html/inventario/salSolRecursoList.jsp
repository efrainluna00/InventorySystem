...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="contenido" type="String">
		...
		<ec:table items="listSolRecursosAprobadas" var="mapf"
			action="${pageContext.request.contextPath}/salSolRecursoAction.do?accion=Find"
			imagePath="${pageContext.request.contextPath}/images/table/compact/*.gif"
			title='Solicitudes de Recursos Aprobadas' view="compact" width="80%"
			tableId="solRecursosApr" autoIncludeParameters="yes" scope="request">
			<ec:row highlightRow="true">
				...
				<ec:column property="linkSalSolRecursos" title="Acci&oacute;n"
					filterable="false"></ec:column>
			</ec:row>
		</ec:table>
		<BR>
		<script type="text/javascript">
			agregarPaginacion("solRecursosApr");
		</script>
	</tiles:put>
