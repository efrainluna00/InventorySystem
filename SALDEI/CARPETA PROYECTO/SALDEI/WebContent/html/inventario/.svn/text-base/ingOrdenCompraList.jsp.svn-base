...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="contenido" type="String">
		...
		<ec:table items="listSolComprasAprobadas" var="mapf"
			action="${pageContext.request.contextPath}/ingOrdenCompraAction.do?accion=Find"
			imagePath="${pageContext.request.contextPath}/images/table/compact/*.gif"
			title='Solicitudes Aprobadas' view="compact" width="80%"
			tableId="solComprasApr" autoIncludeParameters="yes" scope="request">
			<ec:row highlightRow="true">
				...
				<ec:column property="linkIngSolicitudCompra" title="Acci&oacute;n"
					filterable="false"></ec:column>
			</ec:row>
		</ec:table>
		<BR>
		<script type="text/javascript">
			agregarPaginacion("solComprasApr");
		</script>
