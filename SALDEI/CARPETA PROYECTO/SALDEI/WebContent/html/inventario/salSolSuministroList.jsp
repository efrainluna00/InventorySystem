...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="contenido" type="String">
		...
		<ec:table items="listSolSuministroAprobadas" var="mapf"
			action="${pageContext.request.contextPath}/salSolSuministroAction.do?accion=Find"
			...
			<ec:row highlightRow="true">
				...
				<ec:column property="linkSalSolSuministro" title="Acci&oacute;n"
