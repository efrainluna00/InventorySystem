...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="title" type="String">
		<bean:message key="repSalBod.titulo" />
	</tiles:put>

	<tiles:put name="encabezado" type="String">
		<bean:message key="repSalBod.encabezado" />
	</tiles:put>

	<tiles:put name="contenido" type="String">

		<html:form action="/repSalPorBodegaAction.do" styleId="formulario">
				...
				<div id="container">
					...
					<table align="center">
							...
							<td align="center">
								<fieldset>
									<table align="center">
										<tr>
											<th>
												<bean:message key="repSalBod.fecha_ini" />
											</th>
											<td>
												<html:hidden property="usuario" styleId="usuario"
												...
												<html:messages id="message" footer="errores.pie"
													...
													property="repSalBod.fecha_ini.requerido">
													<br>
										...
										<tr>
											<th>
												<bean:message key="repSalBod.fecha_fin" />
											</th>
											<td>
												...
												<html:messages id="message" footer="errores.pie"
													header="errores.cabecera"
													property="repSalBod.rango_invalido">
													<div id="mensaje">
		    	  	...
		    	  	pulsateMessaje();
												...
												<html:messages id="message" footer="errores.pie"
													header="errores.cabecera"
													property="repSalBod.fecha_fin.requerido">
													<br>
													<span class="error"> <bean:write name="message"
															filter="false" /> </span>
												</html:messages>
										<tr>
											<th>
												<bean:message key="repSalBod.bodega" />
											</th>
											<td>
												...
												<input id="btnCategoria" type="button"
													onclick=" abrirVentana('ldvAction.do?xmlArchivo=bodegas2&codigoUser='+$('#usuario').val());"
													value="..." />
										...
										<tr>
											<th>
												<bean:message key="repSalBod.consumible" />
											</th>
											<td>
									...
									Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;						
										...
										<tr>
											<th>
												<bean:message key="repSalBod.grafico" />
											</th>
											<td>
