...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="title" type="String">
		<bean:message key="repAbas.titulo" />
	</tiles:put>

	<tiles:put name="encabezado" type="String">
		<bean:message key="repAbas.encabezado" />
	</tiles:put>

	<tiles:put name="contenido" type="String">

		<html:form action="/repSugAbasSumAction.do" styleId="formulario"
			target="_blank">
							...
							<td align="center">
								<fieldset>
									<table align="center">
										...
										<tr>
											<th>
												<bean:message key="repAbas.bodega" />
											</th>
											<td>
