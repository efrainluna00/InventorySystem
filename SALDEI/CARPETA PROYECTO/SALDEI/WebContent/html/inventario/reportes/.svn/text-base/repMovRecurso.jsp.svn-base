...
<tiles:insert name="plantillaStandar" definition="plantillaStandar">
	...
	<tiles:put name="title" type="String">
		<bean:message key="repMovRecurso.titulo" />
	</tiles:put>

	<tiles:put name="encabezado" type="String">
		<bean:message key="repMovRecurso.encabezado" />
	</tiles:put>

	<tiles:put name="contenido" type="String">

		<html:form action="/repMovRecursoAction.do" styleId="formulario">
				...
				<div id="container">
					...
					<table align="center">
							...
							<td align="center">
								<fieldset>
									<table align="center">
										...
										<tr>
											<th>
												<bean:message key="repMovRecurso.fecha_ini" />
											</th>
											<td>
												...
												<html:messages id="message" footer="errores.pie"
													...
													property="repMovRecurso.fecha_ini.requerido">
													<br>
										...
										<tr>
											<th>
												<bean:message key="repMovRecurso.fecha_fin" />
											</th>
											<td>
												...
												<html:messages id="message" footer="errores.pie"
													header="errores.cabecera"
													property="repMovRecurso.rango_invalido">
													<div id="mensaje">
		    	  	...
		    	  	pulsateMessaje();
												...
												<html:messages id="message" footer="errores.pie"
													header="errores.cabecera"
													property="repMovRecurso.fecha_fin.requerido">
													<br>
													<span class="error"> <bean:write name="message"
															filter="false" /> </span>
												</html:messages>
